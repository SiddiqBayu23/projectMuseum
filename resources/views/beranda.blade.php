...
<div id="jumbotronCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active" data-bs-interval="4000">
            <img src="{{ asset('images/museum.jpg') }}" class="d-block w-100" style="height: 100vh; object-fit: cover;" alt="Museum">
        ...
        <div class="carousel-item" data-bs-interval="4000">
            <img src="{{ asset('images/foto1.jpg') }}" class="d-block w-100" style="height: 100vh; object-fit: cover;" alt="Koleksi">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100">
        ...
        {{-- Slide 3 --}}
        <div class="carousel-item" data-bs-interval="4000">
            <img src="{{ asset('images/foto2.jpg') }}" class="d-block w-100" style="height: 100vh; object-fit: cover;" alt="Virtual Museum">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100">
        ...
        @foreach ($items as $item)
            <div class="col-6 col-md-3">
                <div class="kotak-ikon border-secondary">
                    <div class="ikon-placeholder p-4">
                        <img src="{{ asset($item['gambar']) }}" class="gambar-beranda" alt="{{ $item['judul'] }}">
                    </div>
